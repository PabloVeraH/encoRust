...
pub use tables::{
    absolute_threshold_db, bark_of_hz, compute_partition_map, scalefactor_sample_rate_index,
    spreading_db, SFB_LONG_BOUNDARIES, SFB_LONG_COUNTS, SFB_SHORT_BOUNDARIES, SFB_SHORT_COUNTS,
};
